            ...
            <div class="blog">
                <div class="blog-item">
                    ...
                    <div class="blog-content">
                        <a href="project-item.php"><h3>Duis sed odio sit amet nibh vulputate cursus</h3></a>
                        ...
                        <a class="btn btn-default" href="project-item.php">Read More <i
                ...
                <div class="blog-item">
                    ...
                    <div class="blog-content">
                        <a href="project-item.php"><h3>Conubia nostra per inceptos himenaeos</h3></a>
                        <div class="entry-meta">
                            <span><i class="icon-user"></i> <a href="#">John</a></span>
                            <span><i class="icon-folder-close"></i> <a href="#">Bootstrap</a></span>
                            <span><i class="icon-calendar"></i> Sept 16th, 2012</span>
                            <span><i class="icon-comment"></i> <a href="project-item.php#comments">0 Comment</a></span>
                        </div>
                        <p>Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor,
                            nisi elit consequat ipsum, nec sagittis sem nibh id elit. Duis sed odio sit amet nibh
                            vulputate cursus a sit amet mauris. Morbi accumsan ipsum velit. Nam nec tellus a odio
